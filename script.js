	...
	roundRef.get().then(function(querySnapshot) {
		...
		roundRef.collection("fixtures").orderBy("date")
		  ...
		  .then(function(docs) {
			...
			htmlFields = htmlFields + "<div class='game'><div class='bonusRow'><button class='buttonBonusDisposal' type='button'>Disposal</button>" + bonusMarkerHTML + "<div class='inputs'><input class='formInput' id='bonusInput-1' list='players' display='none'></input></div></div><div class='bonusRow'><button class='buttonBonusScorer' type='button'>Scorer</button>" + bonusMarkerHTML + "<div class='inputs'><input class='formInput' id='bonusInput-2' list='players' display='none'></input></div></div></div>";
