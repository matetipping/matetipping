...
function attemptLogIn(username, tokenCount) {
	if (loggedIn) {
		...
		$("nav ul li:nth-child(2):not(.selected)").attr("href", "/index.html");
		$("nav ul li:nth-child(3):not(.selected)").attr("href", "/results.html");
		$("nav ul li:nth-child(4):not(.selected)").attr("href", "/profile.html");
		$("nav ul li:nth-child(5):not(.selected)").attr("href", "/cards.html");
		$("nav ul li:nth-child(6):not(.selected)").attr("href", "/games.html");
	} else {
